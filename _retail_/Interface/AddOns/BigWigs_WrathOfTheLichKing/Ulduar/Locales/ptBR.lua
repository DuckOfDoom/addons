...
L = BigWigs:NewBossLocale("Razorscale", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("XT-002 Deconstructor", "ptBR")
if L then
	--L.gravitybomb_other = "Gravity"
	--L.lightbomb_other = "Light"
end

L = BigWigs:NewBossLocale("The Iron Council", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Kologarn", "ptBR")
if L then
	--L.arm = "Arm dies"
...
L = BigWigs:NewBossLocale("Auriaya", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Hodir", "ptBR")
if L then
	--L.hardmode = "Hard mode"
	--L.hardmode_desc = "Show timer for hard mode."
end

L = BigWigs:NewBossLocale("Thorim", "ptBR")
if L then
...
L = BigWigs:NewBossLocale("Freya", "ptBR")
if L then
	--L.wave = "Waves"
...
L = BigWigs:NewBossLocale("Mimiron", "ptBR")
if L then
	--L.phase = "Phases"
...
L = BigWigs:NewBossLocale("General Vezax", "ptBR")
if L then
	--L.surge_bar = "Surge %d"
...
L = BigWigs:NewBossLocale("Yogg-Saron", "ptBR")
if L then
